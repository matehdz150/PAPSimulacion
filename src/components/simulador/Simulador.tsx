...
import { simulate, type SimConfig, type SimResult } from '@/lib/simulate-simple';
...
export default function Simulador() {
  const [cfg, setCfg] = useState<SimConfig>({ interarrival: 8, service: 12, mechanics: 2, horizon: 480 });
  ...
  return (
    <div className="min-h-screen bg-[#fbfbfc] font-sans text-[#18181b] antialiased [text-rendering:optimizeLegibility]">
      ...
      <main className="mx-auto max-w-[1280px] px-7 pb-20 pt-[30px]">
        ...
        <Flow phase={phase} result={result} />
        ...
        <div className="grid grid-cols-[384px_1fr] items-start gap-[22px]">
          ...
          <section className="rounded-xl border border-[#ececef] bg-white shadow-[0_1px_2px_rgba(24,24,27,.04),0_1px_1px_rgba(24,24,27,.03)]">
            ...
            <div className="px-5 pb-5 pt-2">
              <NumField
                ...
                min={1}
                max={240}
                hint="Intervalo promedio entre la llegada de dos autos consecutivos."
              />
              <NumField
                ...
                min={1}
                max={480}
                hint="Duración promedio del servicio de un mecánico por auto."
              />
              <NumField
          ...
          <div>
            {!result ? (
              ...
              <Results result={result} runCount={runIdx.current} />
            )}
          </div>
        </div>
      </main>
